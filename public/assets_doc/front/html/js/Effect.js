...
var Obj_Display = $G(ObjectId).style.display;
	...
	$G(parentId).innerHTML = "<a href=javascript:void(0) onClick=javascript:Effect('"+ObjectId+"','"+parentId+"');><img src='../images/hioki_land_sp.jpg' width='27'></a>"
	}else{ 
...
var Obj_Display = $G(ObjectId).style.display;
	if (Obj_Display == 'none'){
	Start(ObjectId,'Opens');
	$G(parentId).innerHTML = "<a href=javascript:void(0) onClick=javascript:Effect2('"+ObjectId+"','"+parentId+"');><img src='../images/hioki_nav02_sp.jpg' width='27' ></a>"
	}else{ 
	Start(ObjectId,'Close');
	$G(parentId).innerHTML = "<a href=javascript:void(0) onClick=javascript:Effect2('"+ObjectId+"','"+parentId+"');><img src='../images/hioki_nav_sp.jpg' width='27' ></a>"
	}
}
...
var Obj_Display = $G(ObjectId).style.display;
	if (Obj_Display == 'none'){
	Start(ObjectId,'Opens');
	$G(parentId).innerHTML = "<a href=javascript:void(0) onClick=javascript:Effect3('"+ObjectId+"','"+parentId+"');><img src='../images/hioki_search_sp.jpg' width='27' ></a>"
	}else{ 
	Start(ObjectId,'Close');
	$G(parentId).innerHTML = "<a href=javascript:void(0) onClick=javascript:Effect3('"+ObjectId+"','"+parentId+"');><img src='../images/hioki_search_sp.jpg' width='27' ></a>"
	}

...
<p class="sp_block fr pad_block" onclick="Effect('nav_sp','nav_sptab');"><span id="nav_sptab"><img src="/assets_doc/front/html/images/hioki_nav_sp.jpg" width="27" ></span></p>
<p class="sp_block fr pad_block land_spding" onclick="Effect('land_sp','land_sptab');"><img src="/assets_doc/front/html/images/hioki_land_sp.jpg" width="27" ><span id="land_sptab" style="display: none;"></span></p>
<p class="sp_block fr pad_block" onclick="Effect('search_sp','search_sptab');"><img src="/assets_doc/front/html/images/hioki_search_sp.jpg" width="27" ><span id="search_sptab" style="display: none;"></span></p>

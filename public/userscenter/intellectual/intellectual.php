...
?>
  <div class="product_right">
    ...
    <p class="recorder_red m_top5">　　※请务必填写正确的邮箱。<br />
　　※若您没有收到通知邮件，可联系 <a href="mailto:chenlu@hioki.com.cn">chenlu@hioki.com.cn</a></p>
	<p class="recorder_red m_top20">　　<a href="../register.php"><img src="../images/intellectual_r8_c4.jpg" width="360" height="86" /></a></p>
    <p class="recorder_f16 m_top30">2.　我们在收到您的信息后将及时以邮件方式通知您资料下载的路径和密码。</p>
    <p class="news_title_x">&nbsp;</p>

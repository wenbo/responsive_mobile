...
?>
<div class="register_banner pad_none sp_none"></div>
<div class="pad_block sp_none"><img src="/assets_doc/front/html/images/register_r1_c1_pad.jpg" width=100%></div>
<div class="sp_block"><img src="/assets_doc/front/html/images/register_r1_c1_sp.jpg" class="sp_w100"></div>
      ...
      <div class="product_right product_right_ins">
        <p class="current sp_none"><a href="/index.html">首页</a> > 注册新会员</p>
      <h3 class="hioki_category_title m_top20 sp_color sp_w100">注册新会员</h3>
      ...
      <div class="register_content pad_w100">
        <form name="FORMADD" method="post" action="reg_confirm.php" onsubmit="return checkFrom();">
          ...
          <dl class="register_dl register_other clearfix">
            <dd class="br">是否使用日置产品</dd><br class="sp_block">
            <dt>
          ...
          <dl class="register_dl register_other  register_th clearfix">
            <dd>日置产品1</dd>
            <dt>
              <span class="size">型号　</span><input name="hioki_code1" id="hioki_code1" type="text" class="register_text register_text_lis" /><span class="register_f14 sp_fn">　例：8870-21</span>
              <p class="m_top30 sp_mt0"><span class="size">名称　</span><input name="hioki_name1" id="hioki_name1" type="text" class="register_text register_text_lis" /><span class="register_f14 sp_fn">　例：存储记录仪</span>
              </p>
            </dt>
          </dl>
          <dl class="register_dl register_other  register_th clearfix">
            <dd>日置产品2</dd>
            <dt>
              <span class="size">型号　</span><input name="hioki_code2" id="hioki_code2" type="text" class="register_text register_text_lis" />
              <p class="m_top30 sp_mt0"><span class="size">名称　</span><input name="hioki_name2" id="hioki_name2" type="text" class="register_text register_text_lis" />
              </p>
            </dt>
          </dl>
          <dl class="register_dl register_other  register_th clearfix">
            <dd>日置产品3</dd>
            <dt>
              <span class="size">型号　</span><input name="hioki_code3" id="hioki_code3" type="text" class="register_text register_text_lis" />
              <p class="m_top30 sp_mt0"><span class="size">名称　</span><input name="hioki_name3" id="hioki_name3" type="text" class="register_text register_text_lis" />
              </p>
            </dt>
          </dl>
          <dl class="register_dl register_other  register_th clearfix">
            <dd>其它产品1</dd>
            <dt>
              <span class="size">型号　</span><input name="other_code1" id="other_code1" type="text" class="register_text register_text_lis" />
              <p class="m_top30 sp_mt0"><span class="size">名称　</span><input name="other_name1" id="hioki_name1" type="text" class="register_text register_text_lis" />
              </p>
            </dt>
          </dl>
          <dl class="register_dl register_other  register_th clearfix">
            <dd>其它产品2</dd>
            <dt>
              <span class="size">型号　</span><input name="other_code2" id="other_code2" type="text" class="register_text register_text_lis" />
              <p class="m_top30 sp_mt0"><span class="size">名称　</span><input name="other_name2" id="other_name2" type="text" class="register_text register_text_lis" />
              </p>
            </dt>
          </dl>
          <dl class="register_dl register_other  register_th clearfix">
            <dd>其它产品3</dd>
            <dt>
              <span class="size">型号　</span><input name="other_code3" id="other_code3" type="text" class="register_text register_text_lis" />
              <p class="m_top30 sp_mt0"><span class="size">名称　</span><input name="other_name3" id="other_name3" type="text" class="register_text register_text_lis" />
              </p>
            </dt>
          </dl>
          <dl class="register_dl register_other clearfix">
            <dd class="br">希望得到哪种信息</dd>
            <dt>
          ...
          <dl class="register_dl register_other clearfix" style="border:none;">
            <dd>意见和建议</dd>
            <dt><textarea name="feedback" id="feedback" cols="50" rows="6" class="register_textarea"></textarea>
            </dt>
          </dl>
          <div class="counterfeit_fill"><input name="" type="submit" value="" class="counterfeit_button04 sp_none" />&nbsp;&nbsp;<input name="" type="reset" value="" class="counterfeit_button02 sp_none" />
            <input name="" type="submit" value="提    交" class="counterfeit_button04 counterfeit_button01 sp_block" />&nbsp;&nbsp;<input name="" type="reset" value="返    回" class="counterfeit_button02 counterfeit_button03 sp_block" />
          </form>
                                </div>
